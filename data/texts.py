...
ENTER_REPLENISHMENT_AMOUNT = '{:s} Введите сумму пополнения.'
...
DELETION_ERROR = 'Бот не может этого пользователя! Возможно бот не администратор.'
...
ERROR_KICK_PARAMS = (
    'Введите ID в качестве аргумента или ответьте на сообщение, пользователя, которого нужно кикнуть.'
)
